...
//close navbar when clicking item start//
...
//close navbar when clicking item end//
...
function showSlides(n) {
  ...
  if (n > slides.length) {slideIndex = 1}
    ...
    for (i = 0; i < dots.length; i++) {
      dots[i].className = dots[i].className.replace(" activeTestimonials", "");
    }
  slides[slideIndex-1].style.display = "block";
  dots[slideIndex-1].className += " activeTestimonials";
}
